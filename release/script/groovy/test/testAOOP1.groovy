...
data_Zr3Cu8 = Structures.from(POSCAR.read('lmp/data/Zr3Cu8.poscar'), 4).opt().perturbG(0.25);
...
plt.plot(q4_Zr3Cu8 , q6_Zr3Cu8 , 'Zr3Cu8' ).lineType('none').markerType('o').markerSize(4);
plt.plot(q4_Zr7Cu10, q6_Zr7Cu10, 'Zr7Cu10').lineType('none').markerType('o').markerSize(4);
plt.plot(q4_ZrCu2  , q6_ZrCu2  , 'ZrCu2'  ).lineType('none').markerType('o').markerSize(4);
plt.plot(q4_MgCu2  , q6_MgCu2  , 'MgCu2'  ).lineType('none').markerType('o').markerSize(4);
