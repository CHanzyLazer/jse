...
def dataZr3Cu8  = Structures.from(POSCAR.read('lmp/data/Zr3Cu8.poscar'), 4).opt().perturbG(0.25);
if (onlyCu) dataZr3Cu8 = dataZr3Cu8.opt().filterType(2);
if (onlyZr) dataZr3Cu8 = dataZr3Cu8.opt().filterType(1);
def dataZr7Cu10 = Structures.from(POSCAR.read('lmp/data/Zr7Cu10.poscar'), 4).opt().perturbG(0.25);
if (onlyCu) dataZr7Cu10 = dataZr7Cu10.opt().filterType(2);
if (onlyZr) dataZr7Cu10 = dataZr7Cu10.opt().filterType(1);
def dataZrCu2   = Structures.from(POSCAR.read('lmp/data/ZrCu2.poscar'), 6).opt().perturbG(0.25);
