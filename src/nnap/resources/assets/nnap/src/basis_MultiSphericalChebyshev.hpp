...
static void calCnlm(jdouble *aNlDx, jdouble *aNlDy, jdouble *aNlDz, jint *aNlType, jint aNN,
    ...
    for (jint j = 0; j < aNN; ++j) {
        ...
        calRn(rRn, aNMax, dis, aRCutMax, aRFuncScale);
        // cal Y
        ...
        jdouble *tCnlm = rCnlm;
        for (jint k = 0; k < aRCutsSize; ++k, tCnlm+=tSizeBnlm) {
            ...
            mplusCnlm(tCnlm, rY, fc, rRn, aNMax, aLMax);
        }
    }
}
static void calCnlm(jdouble *aNlDx, jdouble *aNlDy, jdouble *aNlDz, jint *aNlType, jint aNN,
...
static void calFp(jdouble *aNlDx, jdouble *aNlDy, jdouble *aNlDz, jint *aNlType, jint aNN,
    ...
    // system scale here
    for (jint n=0, tShift=0, tShiftS=0; n<tEquFuseInDim; ++n, tShift+=tLMAll, tShiftS+=aLMax+1) {
