#include "jsex_nnap_nn_TorchModel.h"
#include "jsex_nnap_nn_TorchModel.h"
#include "jniutil.h"
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchModel_setSingleThread0(JNIEnv *aEnv, jclass aClazz) {
    try {
...
JNIEXPORT jlong JNICALL Java_jsex_nnap_nn_TorchModel_load0(JNIEnv *aEnv, jclass aClazz, jstring aModelPath) {
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchPointer_dispose0(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr) {
    delete (torch::jit::Module *)(intptr_t)aModelPtr;
}

JNIEXPORT jdouble JNICALL Java_jsex_nnap_nn_TorchModel_forward0(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jdoubleArray aX, jint aStart, jint aCount) {
...
JNIEXPORT jdouble JNICALL Java_jsex_nnap_nn_TorchModel_forward1(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jlong aX, jint aCount) {
    torch::jit::Module *tModulePtr = (torch::jit::Module *)(intptr_t)aModelPtr;
    jboolean tAnyErr = JNI_FALSE;
    torch::Tensor tXTensor;
    try {
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchModel_batchForward0(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jdoubleArray aX, jint aStart, jint aCount, jdoubleArray rY, jint rYStart, jint aBatchSize) {
    torch::jit::Module *tModulePtr = (torch::jit::Module *)(intptr_t)aModelPtr;
    jboolean tAnyErr = JNI_FALSE;
    torch::Tensor tXTensor;
    try {
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchModel_batchForward1(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jlong aX, jint aCount, jlong rY, jint aBatchSize) {
    torch::jit::Module *tModulePtr = (torch::jit::Module *)(intptr_t)aModelPtr;
    jboolean tAnyErr = JNI_FALSE;
    torch::Tensor tXTensor;
    try {
...
JNIEXPORT jdouble JNICALL Java_jsex_nnap_nn_TorchModel_backward0(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jdoubleArray aX, jint aStart, jdoubleArray rGradX, jint rStart, jint aCount) {
    ...
    try {
        ...
        torch::Tensor tGradX = torch::autograd::grad({tYTensor.sum()}, {tXTensor})[0];
        parsedouble2jdoubleV(aEnv, rGradX, rStart, tGradX.contiguous().const_data_ptr<double>(), 0, aCount);
    } catch (const std::exception &e) {
        tAnyErr = JNI_TRUE;
        throwExceptionTorch(aEnv, e.what());
    }
...
JNIEXPORT jdouble JNICALL Java_jsex_nnap_nn_TorchModel_backward1(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jlong aX, jlong rGradX, jint aCount) {
    ...
    try {
        ...
        tY = tYTensor.item<double>();
        torch::Tensor tGradX = torch::autograd::grad({tYTensor.sum()}, {tXTensor})[0];
        std::memcpy((double *)(intptr_t)rGradX, tGradX.contiguous().const_data_ptr<double>(), aCount*sizeof(double));
    } catch (const std::exception &e) {
        tAnyErr = JNI_TRUE;
        throwExceptionTorch(aEnv, e.what());
    }
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchModel_batchBackward0(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jdoubleArray aX, jint aStart, jdoubleArray rGradX, jint rStart, jint aCount, jdoubleArray rY, jint rYStart, jint aBatchSize) {
    ...
    try {
        ...
        torch::Tensor tGradX = torch::autograd::grad({tYTensor.sum()}, {tXTensor})[0];
        parsedouble2jdoubleV(aEnv, rGradX, rStart, tGradX.contiguous().const_data_ptr<double>(), 0, aBatchSize*aCount);
    } catch (const std::exception &e) {
        tAnyErr = JNI_TRUE;
        throwExceptionTorch(aEnv, e.what());
    }
...
JNIEXPORT void JNICALL Java_jsex_nnap_nn_TorchModel_batchBackward1(JNIEnv *aEnv, jclass aClazz, jlong aModelPtr, jlong aX, jlong rGradX, jint aCount, jlong rY, jint aBatchSize) {
    ...
    try {
        ...
        torch::Tensor tGradX = torch::autograd::grad({tYTensor.sum()}, {tXTensor})[0];
        std::memcpy((double *)(intptr_t)rGradX, tGradX.contiguous().const_data_ptr<double>(), aBatchSize*aCount*sizeof(double));
    } catch (const std::exception &e) {
        tAnyErr = JNI_TRUE;
        throwExceptionTorch(aEnv, e.what());
    }
