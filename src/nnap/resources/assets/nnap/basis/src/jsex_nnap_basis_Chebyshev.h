 ...
 * Method:    eval1
 * Signature: ([D[D[D[II[D[DIDII)V
 */
JNIEXPORT void JNICALL Java_jsex_nnap_basis_Chebyshev_eval1
  (JNIEnv *, jclass, jdoubleArray, jdoubleArray, jdoubleArray, jintArray, jint, jdoubleArray, jdoubleArray, jint, jdouble, jint, jint);

/*
 * Class:     jsex_nnap_basis_Chebyshev
 * Method:    evalPartial1
 * Signature: ([D[D[D[II[D[D[D[D[D[D[D[D[D[D[D[DIDII)V
 */
JNIEXPORT void JNICALL Java_jsex_nnap_basis_Chebyshev_evalPartial1
  (JNIEnv *, jclass, jdoubleArray, jdoubleArray, jdoubleArray, jintArray, jint, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jdoubleArray, jint, jdouble, jint, jint);
