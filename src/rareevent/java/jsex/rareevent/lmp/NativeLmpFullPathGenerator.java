...
public class NativeLmpFullPathGenerator implements IFullPathGenerator<IAtomData> {
    ...
    private final double mTemperature, mPressure;
     ...
     * @param aPressure 创建路径的压强，默认为 0.0 (bar)
     ...
     */
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList, IVector aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep, byte aThermostat) throws LmpException {
        // 基本参数存储
    ...
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                      IVector aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep                  ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, aMasses, aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, aDumpStep, NOSE_HOOVER);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                      IVector aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep                                 ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, aMasses, aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, 10);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                      IVector aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff                                                   ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, aMasses, aTemperature, aPressure, aPairStyle, aPairCoeff, 0.002);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList, Collection<? extends Number> aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep, byte aThermostat) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, aDumpStep, aThermostat);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList, Collection<? extends Number> aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep                  ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, aDumpStep);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList, Collection<? extends Number> aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep                                 ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList, Collection<? extends Number> aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff                                                   ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                     double[] aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep, byte aThermostat) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, aDumpStep, aThermostat);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                     double[] aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep                  ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep, aDumpStep);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                     double[] aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff, double aTimestep                                 ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff, aTimestep);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                     double[] aMasses, double aTemperature, double aPressure, String aPairStyle, String aPairCoeff                                                   ) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, Vectors.from(aMasses), aTemperature, aPressure, aPairStyle, aPairCoeff);}
    public NativeLmpFullPathGenerator(MPI.Comm aLmpComm, IParameterCalculator<? super IAtomData> aParameterCalculator, Iterable<? extends IAtomData> aInitAtomDataList,                      IVector aMasses, double aTemperature,                   String aPairStyle, String aPairCoeff, double aTimestep, int aDumpStep, byte aThermostat) throws LmpException {this(aLmpComm, aParameterCalculator, aInitAtomDataList, aMasses, aTemperature, 0.0, aPairStyle, aPairCoeff, aTimestep, aDumpStep, aThermostat);}
    ...
    private class NativeLmpIterator implements ITimeAndParameterIterator<Lmpdat> {
        ...
        protected void initLmp_() throws LmpException {
            ...
            case LANGEVIN: {
                ...
                mLmp.command("fix             3 all press/berendsen iso "+mPressure+" "+mPressure+" "+(mTimestep*1000.0*1000.0));
                break;
            }
            case NOSE_HOOVER: default: {
                mLmp.command("fix             1 all npt temp "+mTemperature+" "+mTemperature+" "+(mTimestep*100.0)+" iso "+mPressure+" "+mPressure+" "+(mTimestep*1000.0));
                break;
            }}
        }
