...
public class CudaJIT {
    ...
    public static class Engine extends SimpleJIT.Engine {
        ...
        public Engine setCmakeCudaArch(@Nullable String aCmakeCudaArch) {
            mCmakeCudaArch = aCmakeCudaArch;
            return this;
        }
        ...
        @Override protected void preInitCmakeCmd(List<String> rCommand) {
            ...
            // cuda 架构这里需要专门设置，根据优化等级自动调整
            String tCmakeCudaArch = mCmakeCudaArch;
            if (tCmakeCudaArch==null) {
                switch(mOptimLevel) {
                case OPTIM_MAX: case OPTIM_BASE: {
                    tCmakeCudaArch = "native";
                    break;
                }
                case OPTIM_COMPAT: case OPTIM_NONE: {
                    tCmakeCudaArch = "75";
                    break;
                }
                }
            }
            rCommand.add("-D"); rCommand.add("CMAKE_CUDA_ARCHITECTURES=\""+tCmakeCudaArch+"\"");
        }
