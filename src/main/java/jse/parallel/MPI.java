...
import static jse.code.CS.Exec.JNILIB_EXTENSION;
...
public class MPI {
    ...
    public static class Native {
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-allgather-function"> MPI_Allgather function </a>
         */
        public static void MPI_Allgather(byte[]    aSendBuf, int aSendCount, byte[]    rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JBYTE   , rRecvBuf, aRecvCount, MPI_JBYTE   , aComm);}
        public static void MPI_Allgather(double[]  aSendBuf, int aSendCount, double[]  rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JDOUBLE , rRecvBuf, aRecvCount, MPI_JDOUBLE , aComm);}
        public static void MPI_Allgather(boolean[] aSendBuf, int aSendCount, boolean[] rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JBOOLEAN, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aComm);}
        public static void MPI_Allgather(char[]    aSendBuf, int aSendCount, char[]    rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JCHAR   , rRecvBuf, aRecvCount, MPI_JCHAR   , aComm);}
        public static void MPI_Allgather(short[]   aSendBuf, int aSendCount, short[]   rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JSHORT  , rRecvBuf, aRecvCount, MPI_JSHORT  , aComm);}
        public static void MPI_Allgather(int[]     aSendBuf, int aSendCount, int[]     rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JINT    , rRecvBuf, aRecvCount, MPI_JINT    , aComm);}
        public static void MPI_Allgather(long[]    aSendBuf, int aSendCount, long[]    rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JLONG   , rRecvBuf, aRecvCount, MPI_JLONG   , aComm);}
        public static void MPI_Allgather(float[]   aSendBuf, int aSendCount, float[]   rRecvBuf, int aRecvCount, long aComm) throws Error {MPI_Allgather0(false, aSendBuf, aSendCount, MPI_JFLOAT  , rRecvBuf, aRecvCount, MPI_JFLOAT  , aComm);}
        public static void MPI_Allgather(byte[]    rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBYTE   , aComm);}
        public static void MPI_Allgather(double[]  rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JDOUBLE , aComm);}
        public static void MPI_Allgather(boolean[] rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBOOLEAN, aComm);}
        public static void MPI_Allgather(char[]    rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JCHAR   , aComm);}
        public static void MPI_Allgather(short[]   rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JSHORT  , aComm);}
        public static void MPI_Allgather(int[]     rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JINT    , aComm);}
        public static void MPI_Allgather(long[]    rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JLONG   , aComm);}
        public static void MPI_Allgather(float[]   rBuf, int aCount, long aComm) throws Error {MPI_Allgather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JFLOAT  , aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-allgatherv-function"> MPI_Allgatherv function </a>
         */
        public static void MPI_Allgatherv(byte[]    aSendBuf, int aSendCount, byte[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JBYTE   , rRecvBuf, aRecvCounts, aDispls, MPI_JBYTE   , aComm);}
        public static void MPI_Allgatherv(double[]  aSendBuf, int aSendCount, double[]  rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JDOUBLE , rRecvBuf, aRecvCounts, aDispls, MPI_JDOUBLE , aComm);}
        public static void MPI_Allgatherv(boolean[] aSendBuf, int aSendCount, boolean[] rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JBOOLEAN, rRecvBuf, aRecvCounts, aDispls, MPI_JBOOLEAN, aComm);}
        public static void MPI_Allgatherv(char[]    aSendBuf, int aSendCount, char[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JCHAR   , rRecvBuf, aRecvCounts, aDispls, MPI_JCHAR   , aComm);}
        public static void MPI_Allgatherv(short[]   aSendBuf, int aSendCount, short[]   rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JSHORT  , rRecvBuf, aRecvCounts, aDispls, MPI_JSHORT  , aComm);}
        public static void MPI_Allgatherv(int[]     aSendBuf, int aSendCount, int[]     rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JINT    , rRecvBuf, aRecvCounts, aDispls, MPI_JINT    , aComm);}
        public static void MPI_Allgatherv(long[]    aSendBuf, int aSendCount, long[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JLONG   , rRecvBuf, aRecvCounts, aDispls, MPI_JLONG   , aComm);}
        public static void MPI_Allgatherv(float[]   aSendBuf, int aSendCount, float[]   rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(false, aSendBuf, aSendCount, MPI_JFLOAT  , rRecvBuf, aRecvCounts, aDispls, MPI_JFLOAT  , aComm);}
        public static void MPI_Allgatherv(byte[]    rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JBYTE   , aComm);}
        public static void MPI_Allgatherv(double[]  rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JDOUBLE , aComm);}
        public static void MPI_Allgatherv(boolean[] rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JBOOLEAN, aComm);}
        public static void MPI_Allgatherv(char[]    rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JCHAR   , aComm);}
        public static void MPI_Allgatherv(short[]   rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JSHORT  , aComm);}
        public static void MPI_Allgatherv(int[]     rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JINT    , aComm);}
        public static void MPI_Allgatherv(long[]    rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JLONG   , aComm);}
        public static void MPI_Allgatherv(float[]   rBuf, int[] aCounts, int[] aDispls, long aComm) throws Error {MPI_Allgatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JFLOAT  , aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-allreduce-function"> MPI_Allreduce function </a>
         */
        public static void MPI_Allreduce(byte[]    aSendBuf, byte[]    rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JBYTE   , aOp, aComm);}
        public static void MPI_Allreduce(double[]  aSendBuf, double[]  rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JDOUBLE , aOp, aComm);}
        public static void MPI_Allreduce(boolean[] aSendBuf, boolean[] rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JBOOLEAN, aOp, aComm);}
        public static void MPI_Allreduce(char[]    aSendBuf, char[]    rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JCHAR   , aOp, aComm);}
        public static void MPI_Allreduce(short[]   aSendBuf, short[]   rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JSHORT  , aOp, aComm);}
        public static void MPI_Allreduce(int[]     aSendBuf, int[]     rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JINT    , aOp, aComm);}
        public static void MPI_Allreduce(long[]    aSendBuf, long[]    rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JLONG   , aOp, aComm);}
        public static void MPI_Allreduce(float[]   aSendBuf, float[]   rRecvBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JFLOAT  , aOp, aComm);}
        public static void MPI_Allreduce(byte[]    rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JBYTE   , aOp, aComm);}
        public static void MPI_Allreduce(double[]  rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JDOUBLE , aOp, aComm);}
        public static void MPI_Allreduce(boolean[] rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JBOOLEAN, aOp, aComm);}
        public static void MPI_Allreduce(char[]    rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JCHAR   , aOp, aComm);}
        public static void MPI_Allreduce(short[]   rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JSHORT  , aOp, aComm);}
        public static void MPI_Allreduce(int[]     rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JINT    , aOp, aComm);}
        public static void MPI_Allreduce(long[]    rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JLONG   , aOp, aComm);}
        public static void MPI_Allreduce(float[]   rBuf, int aCount, long aOp, long aComm) throws Error {MPI_Allreduce0(true, null, rBuf, aCount, MPI_JFLOAT  , aOp, aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-bcast-function"> MPI_Bcast function </a>
         */
        public static void MPI_Bcast(byte[]    rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JBYTE   , aRoot, aComm);}
        public static void MPI_Bcast(double[]  rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JDOUBLE , aRoot, aComm);}
        public static void MPI_Bcast(boolean[] rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JBOOLEAN, aRoot, aComm);}
        public static void MPI_Bcast(char[]    rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JCHAR   , aRoot, aComm);}
        public static void MPI_Bcast(short[]   rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JSHORT  , aRoot, aComm);}
        public static void MPI_Bcast(int[]     rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JINT    , aRoot, aComm);}
        public static void MPI_Bcast(long[]    rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JLONG   , aRoot, aComm);}
        public static void MPI_Bcast(float[]   rBuf, int aCount, int aRoot, long aComm) throws Error {MPI_Bcast0(rBuf, aCount, MPI_JFLOAT  , aRoot, aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-gather-function"> MPI_Gather function </a>
         */
        public static void MPI_Gather(byte[]    aSendBuf, int aSendCount, byte[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JBYTE   , rRecvBuf, aRecvCount, MPI_JBYTE   , aRoot, aComm);}
        public static void MPI_Gather(double[]  aSendBuf, int aSendCount, double[]  rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JDOUBLE , rRecvBuf, aRecvCount, MPI_JDOUBLE , aRoot, aComm);}
        public static void MPI_Gather(boolean[] aSendBuf, int aSendCount, boolean[] rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JBOOLEAN, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aRoot, aComm);}
        public static void MPI_Gather(char[]    aSendBuf, int aSendCount, char[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JCHAR   , rRecvBuf, aRecvCount, MPI_JCHAR   , aRoot, aComm);}
        public static void MPI_Gather(short[]   aSendBuf, int aSendCount, short[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JSHORT  , rRecvBuf, aRecvCount, MPI_JSHORT  , aRoot, aComm);}
        public static void MPI_Gather(int[]     aSendBuf, int aSendCount, int[]     rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JINT    , rRecvBuf, aRecvCount, MPI_JINT    , aRoot, aComm);}
        public static void MPI_Gather(long[]    aSendBuf, int aSendCount, long[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JLONG   , rRecvBuf, aRecvCount, MPI_JLONG   , aRoot, aComm);}
        public static void MPI_Gather(float[]   aSendBuf, int aSendCount, float[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Gather0(false, aSendBuf, aSendCount, MPI_JFLOAT  , rRecvBuf, aRecvCount, MPI_JFLOAT  , aRoot, aComm);}
        public static void MPI_Gather(byte[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBYTE   , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JBYTE   , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(double[]  rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JDOUBLE , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JDOUBLE , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(boolean[] rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBOOLEAN, aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JBOOLEAN, null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(char[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JCHAR   , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JCHAR   , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(short[]   rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JSHORT  , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JSHORT  , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(int[]     rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JINT    , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JINT    , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(long[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JLONG   , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JLONG   , null, 0, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gather(float[]   rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Gather0(true, null, 0, MPI_JNULL, rBuf, aCount, MPI_JFLOAT  , aRoot, aComm);} else {MPI_Gather0(false, rBuf, aCount, MPI_JFLOAT  , null, 0, MPI_JNULL, aRoot, aComm);}}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-gatherv-function"> MPI_Gatherv function </a>
         */
        public static void MPI_Gatherv(byte[]    aSendBuf, int aSendCount, byte[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JBYTE   , rRecvBuf, aRecvCounts, aDispls, MPI_JBYTE   , aRoot, aComm);}
        public static void MPI_Gatherv(double[]  aSendBuf, int aSendCount, double[]  rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JDOUBLE , rRecvBuf, aRecvCounts, aDispls, MPI_JDOUBLE , aRoot, aComm);}
        public static void MPI_Gatherv(boolean[] aSendBuf, int aSendCount, boolean[] rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JBOOLEAN, rRecvBuf, aRecvCounts, aDispls, MPI_JBOOLEAN, aRoot, aComm);}
        public static void MPI_Gatherv(char[]    aSendBuf, int aSendCount, char[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JCHAR   , rRecvBuf, aRecvCounts, aDispls, MPI_JCHAR   , aRoot, aComm);}
        public static void MPI_Gatherv(short[]   aSendBuf, int aSendCount, short[]   rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JSHORT  , rRecvBuf, aRecvCounts, aDispls, MPI_JSHORT  , aRoot, aComm);}
        public static void MPI_Gatherv(int[]     aSendBuf, int aSendCount, int[]     rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JINT    , rRecvBuf, aRecvCounts, aDispls, MPI_JINT    , aRoot, aComm);}
        public static void MPI_Gatherv(long[]    aSendBuf, int aSendCount, long[]    rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JLONG   , rRecvBuf, aRecvCounts, aDispls, MPI_JLONG   , aRoot, aComm);}
        public static void MPI_Gatherv(float[]   aSendBuf, int aSendCount, float[]   rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) throws Error {MPI_Gatherv0(false, aSendBuf, aSendCount, MPI_JFLOAT  , rRecvBuf, aRecvCounts, aDispls, MPI_JFLOAT  , aRoot, aComm);}
        public static void MPI_Gatherv(byte[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JBYTE   , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JBYTE   , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(double[]  rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JDOUBLE , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JDOUBLE , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(boolean[] rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JBOOLEAN, aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JBOOLEAN, null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(char[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JCHAR   , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JCHAR   , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(short[]   rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JSHORT  , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JSHORT  , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(int[]     rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JINT    , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JINT    , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(long[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JLONG   , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JLONG   , null, null, null, MPI_JNULL, aRoot, aComm);}}
        public static void MPI_Gatherv(float[]   rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Gatherv0(true, null, 0, MPI_JNULL, rBuf, aCounts, aDispls, MPI_JFLOAT  , aRoot, aComm);} else {MPI_Gatherv0(false, rBuf, aCounts[tRank], MPI_JFLOAT  , null, null, null, MPI_JNULL, aRoot, aComm);}}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-reduce-function"> MPI_Reduce function </a>
         */
        public static void MPI_Reduce(byte[]    aSendBuf, byte[]    rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JBYTE   , aOp, aRoot, aComm);}
        public static void MPI_Reduce(double[]  aSendBuf, double[]  rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JDOUBLE , aOp, aRoot, aComm);}
        public static void MPI_Reduce(boolean[] aSendBuf, boolean[] rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JBOOLEAN, aOp, aRoot, aComm);}
        public static void MPI_Reduce(char[]    aSendBuf, char[]    rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JCHAR   , aOp, aRoot, aComm);}
        public static void MPI_Reduce(short[]   aSendBuf, short[]   rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JSHORT  , aOp, aRoot, aComm);}
        public static void MPI_Reduce(int[]     aSendBuf, int[]     rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JINT    , aOp, aRoot, aComm);}
        public static void MPI_Reduce(long[]    aSendBuf, long[]    rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JLONG   , aOp, aRoot, aComm);}
        public static void MPI_Reduce(float[]   aSendBuf, float[]   rRecvBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {MPI_Reduce0(false, aSendBuf, rRecvBuf, aCount, MPI_JFLOAT  , aOp, aRoot, aComm);}
        public static void MPI_Reduce(byte[]    rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JBYTE   , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JBYTE   , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(double[]  rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JDOUBLE , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JDOUBLE , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(boolean[] rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JBOOLEAN, aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JBOOLEAN, aOp, aRoot, aComm);}}
        public static void MPI_Reduce(char[]    rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JCHAR   , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JCHAR   , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(short[]   rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JSHORT  , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JSHORT  , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(int[]     rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JINT    , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JINT    , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(long[]    rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JLONG   , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JLONG   , aOp, aRoot, aComm);}}
        public static void MPI_Reduce(float[]   rBuf, int aCount, long aOp, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Reduce0(true, null, rBuf, aCount, MPI_JFLOAT  , aOp, aRoot, aComm);} else {MPI_Reduce0(false, rBuf, null, aCount, MPI_JFLOAT  , aOp, aRoot, aComm);}}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-scatter-function"> MPI_Scatter function </a>
         */
        public static void MPI_Scatter(byte[]    aSendBuf, int aSendCount, byte[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JBYTE   , rRecvBuf, aRecvCount, MPI_JBYTE   , aRoot, aComm);}
        public static void MPI_Scatter(double[]  aSendBuf, int aSendCount, double[]  rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JDOUBLE , rRecvBuf, aRecvCount, MPI_JDOUBLE , aRoot, aComm);}
        public static void MPI_Scatter(boolean[] aSendBuf, int aSendCount, boolean[] rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JBOOLEAN, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aRoot, aComm);}
        public static void MPI_Scatter(char[]    aSendBuf, int aSendCount, char[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JCHAR   , rRecvBuf, aRecvCount, MPI_JCHAR   , aRoot, aComm);}
        public static void MPI_Scatter(short[]   aSendBuf, int aSendCount, short[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JSHORT  , rRecvBuf, aRecvCount, MPI_JSHORT  , aRoot, aComm);}
        public static void MPI_Scatter(int[]     aSendBuf, int aSendCount, int[]     rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JINT    , rRecvBuf, aRecvCount, MPI_JINT    , aRoot, aComm);}
        public static void MPI_Scatter(long[]    aSendBuf, int aSendCount, long[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JLONG   , rRecvBuf, aRecvCount, MPI_JLONG   , aRoot, aComm);}
        public static void MPI_Scatter(float[]   aSendBuf, int aSendCount, float[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatter0(false, aSendBuf, aSendCount, MPI_JFLOAT  , rRecvBuf, aRecvCount, MPI_JFLOAT  , aRoot, aComm);}
        public static void MPI_Scatter(byte[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JBYTE   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBYTE   , aRoot, aComm);}}
        public static void MPI_Scatter(double[]  rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JDOUBLE , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JDOUBLE , aRoot, aComm);}}
        public static void MPI_Scatter(boolean[] rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JBOOLEAN, null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JBOOLEAN, aRoot, aComm);}}
        public static void MPI_Scatter(char[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JCHAR   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JCHAR   , aRoot, aComm);}}
        public static void MPI_Scatter(short[]   rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JSHORT  , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JSHORT  , aRoot, aComm);}}
        public static void MPI_Scatter(int[]     rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JINT    , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JINT    , aRoot, aComm);}}
        public static void MPI_Scatter(long[]    rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JLONG   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JLONG   , aRoot, aComm);}}
        public static void MPI_Scatter(float[]   rBuf, int aCount, int aRoot, long aComm) throws Error {if (MPI_Comm_rank(aComm) == aRoot) {MPI_Scatter0(true, rBuf, aCount, MPI_JFLOAT  , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatter0(false, null, 0, MPI_JNULL, rBuf, aCount, MPI_JFLOAT  , aRoot, aComm);}}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-scatterv-function"> MPI_Scatterv function </a>
         */
        public static void MPI_Scatterv(byte[]    aSendBuf, int[] aSendCounts, int[] aDispls, byte[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JBYTE   , rRecvBuf, aRecvCount, MPI_JBYTE   , aRoot, aComm);}
        public static void MPI_Scatterv(double[]  aSendBuf, int[] aSendCounts, int[] aDispls, double[]  rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JDOUBLE , rRecvBuf, aRecvCount, MPI_JDOUBLE , aRoot, aComm);}
        public static void MPI_Scatterv(boolean[] aSendBuf, int[] aSendCounts, int[] aDispls, boolean[] rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JBOOLEAN, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aRoot, aComm);}
        public static void MPI_Scatterv(char[]    aSendBuf, int[] aSendCounts, int[] aDispls, char[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JCHAR   , rRecvBuf, aRecvCount, MPI_JCHAR   , aRoot, aComm);}
        public static void MPI_Scatterv(short[]   aSendBuf, int[] aSendCounts, int[] aDispls, short[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JSHORT  , rRecvBuf, aRecvCount, MPI_JSHORT  , aRoot, aComm);}
        public static void MPI_Scatterv(int[]     aSendBuf, int[] aSendCounts, int[] aDispls, int[]     rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JINT    , rRecvBuf, aRecvCount, MPI_JINT    , aRoot, aComm);}
        public static void MPI_Scatterv(long[]    aSendBuf, int[] aSendCounts, int[] aDispls, long[]    rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JLONG   , rRecvBuf, aRecvCount, MPI_JLONG   , aRoot, aComm);}
        public static void MPI_Scatterv(float[]   aSendBuf, int[] aSendCounts, int[] aDispls, float[]   rRecvBuf, int aRecvCount, int aRoot, long aComm) throws Error {MPI_Scatterv0(false, aSendBuf, aSendCounts, aDispls, MPI_JFLOAT  , rRecvBuf, aRecvCount, MPI_JFLOAT  , aRoot, aComm);}
        public static void MPI_Scatterv(byte[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JBYTE   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JBYTE   , aRoot, aComm);}}
        public static void MPI_Scatterv(double[]  rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JDOUBLE , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JDOUBLE , aRoot, aComm);}}
        public static void MPI_Scatterv(boolean[] rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JBOOLEAN, null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JBOOLEAN, aRoot, aComm);}}
        public static void MPI_Scatterv(char[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JCHAR   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JCHAR   , aRoot, aComm);}}
        public static void MPI_Scatterv(short[]   rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JSHORT  , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JSHORT  , aRoot, aComm);}}
        public static void MPI_Scatterv(int[]     rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JINT    , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JINT    , aRoot, aComm);}}
        public static void MPI_Scatterv(long[]    rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JLONG   , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JLONG   , aRoot, aComm);}}
        public static void MPI_Scatterv(float[]   rBuf, int[] aCounts, int[] aDispls, int aRoot, long aComm) throws Error {int tRank = MPI_Comm_rank(aComm); if (tRank == aRoot) {MPI_Scatterv0(true, rBuf, aCounts, aDispls, MPI_JFLOAT  , null, 0, MPI_JNULL, aRoot, aComm);} else {MPI_Scatterv0(false, null, null, null, MPI_JNULL, rBuf, aCounts[tRank], MPI_JFLOAT  , aRoot, aComm);}}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-send-function"> MPI_Send function </a>
         */
        public static void MPI_Send(byte[]    aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JBYTE   , aDest, aTag, aComm);}
        public static void MPI_Send(double[]  aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JDOUBLE , aDest, aTag, aComm);}
        public static void MPI_Send(boolean[] aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JBOOLEAN, aDest, aTag, aComm);}
        public static void MPI_Send(char[]    aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JCHAR   , aDest, aTag, aComm);}
        public static void MPI_Send(short[]   aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JSHORT  , aDest, aTag, aComm);}
        public static void MPI_Send(int[]     aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JINT    , aDest, aTag, aComm);}
        public static void MPI_Send(long[]    aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JLONG   , aDest, aTag, aComm);}
        public static void MPI_Send(float[]   aBuf, int aCount, int aDest, int aTag, long aComm) throws Error {MPI_Send0(aBuf, aCount, MPI_JFLOAT  , aDest, aTag, aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-recv-function"> MPI_Recv function </a>
         */
        public static void MPI_Recv(byte[]    rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JBYTE   , aSource, aTag, aComm);}
        public static void MPI_Recv(double[]  rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JDOUBLE , aSource, aTag, aComm);}
        public static void MPI_Recv(boolean[] rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JBOOLEAN, aSource, aTag, aComm);}
        public static void MPI_Recv(char[]    rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JCHAR   , aSource, aTag, aComm);}
        public static void MPI_Recv(short[]   rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JSHORT  , aSource, aTag, aComm);}
        public static void MPI_Recv(int[]     rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JINT    , aSource, aTag, aComm);}
        public static void MPI_Recv(long[]    rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JLONG   , aSource, aTag, aComm);}
        public static void MPI_Recv(float[]   rBuf, int aCount, int aSource, int aTag, long aComm) throws Error {MPI_Recv0(rBuf, aCount, MPI_JFLOAT  , aSource, aTag, aComm);}
         ...
         * @see <a href="https://learn.microsoft.com/en-us/message-passing-interface/mpi-sendrecv-function"> MPI_Sendrecv function </a>
         */
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(byte[]    aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBYTE   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(double[]  aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JDOUBLE , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(boolean[] aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JBOOLEAN, aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(char[]    aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JCHAR   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(short[]   aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JSHORT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(int[]     aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JINT    , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(long[]    aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JLONG   , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, byte[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBYTE   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, double[]  rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JDOUBLE , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, boolean[] rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JBOOLEAN, aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, char[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JCHAR   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, short[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JSHORT  , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, int[]     rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JINT    , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, long[]    rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JLONG   , aSource, aRecvTag, aComm);}
        public static void MPI_Sendrecv(float[]   aSendBuf, int aSendCount, int aDest, int aSendTag, float[]   rRecvBuf, int aRecvCount, int aSource, int aRecvTag, long aComm) throws Error {MPI_Sendrecv0(aSendBuf, aSendCount, MPI_JFLOAT  , aDest, aSendTag, rRecvBuf, aRecvCount, MPI_JFLOAT  , aSource, aRecvTag, aComm);}
