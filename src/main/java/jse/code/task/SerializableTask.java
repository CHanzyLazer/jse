...
public class SerializableTask extends Task {
    ...
    public static Task fromString(final Object aTaskCreator, String aStr) {
        ...
        case CLEAR_WORKING_DIR: case CLEAR_WORKING_DIR_PAR:
            return fromString_(aTaskCreator, (aTaskCreator instanceof jse.ssh.ServerSSH) ? (jse.ssh.ServerSSH)aTaskCreator : null, tKey, tValue);
        case NULL: default:
            return null;
        }
    }
    
    static Task fromString_(final Object aTaskCreator, jse.ssh.ServerSSH aSSH, Type aKey, String... aValues) {
