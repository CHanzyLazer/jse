...
public class SimpleJIT {
    ...
    public static class Engine implements IJITEngine {
        ...
        public Engine addTypeMap(String aSrcType, String aTargetType) {
            mScanner.addTypeMap(aSrcType, aTargetType);
            return this;
        }
        public Engine setNoExtern(boolean aNoExtern) {
            mNoExtern = aNoExtern;
            return this;
        }
        public Engine setNoExtern() {
            return setNoExtern(true);
        }
        ...
        /// stuff to override
        protected void preInitCmakeCmd(List<String> rCommand) throws IOException {/**/}
        protected void postInitCmakeCmd(List<String> rCommand) throws IOException {/**/}
        private String cmakeInitCmd_() throws IOException {
            ...
            postInitCmakeCmd(rCommand);
            // 初始化使用上一个目录的 CMakeList.txt
            rCommand.add("..");
            return String.join(" ", rCommand);
        }
        
        protected String srcName() {return "jitsrc.cpp";}
        protected String headName() {return "jitsrc.h";}
        ...
        private @NotNull String initLib_() throws Exception {
            ...
            if (mSrc!=null) {
                ...
                writeSrcFile(tSrcDir, srcName(), headName());
            } else {
