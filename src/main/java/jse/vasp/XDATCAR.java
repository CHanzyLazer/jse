...
public class XDATCAR extends AbstractListWrapper<POSCAR, IAtomData, IMatrix> implements IVaspCommonData {
     ...
     * @return 获取到的 MFPC
     */
    @ApiStatus.Experimental public MultiFrameParameterCalculator getTypeMultiFrameParameterCalculator(double aTimestep, int aType, int aThreadNum) {return MultiFrameParameterCalculator.of(AbstractCollections.map(asList(), atomData -> atomData.operation().filterType(aType)), aTimestep, aThreadNum);}
    @ApiStatus.Experimental public MultiFrameParameterCalculator getMultiFrameParameterCalculator    (double aTimestep                           ) {return MultiFrameParameterCalculator.of(asList()                                                                             , aTimestep            );}
    @ApiStatus.Experimental public MultiFrameParameterCalculator getMultiFrameParameterCalculator    (double aTimestep,            int aThreadNum) {return MultiFrameParameterCalculator.of(asList()                                                                             , aTimestep, aThreadNum);}
    @ApiStatus.Experimental public MultiFrameParameterCalculator getTypeMultiFrameParameterCalculator(double aTimestep, int aType                ) {return MultiFrameParameterCalculator.of(AbstractCollections.map(asList(), atomData -> atomData.operation().filterType(aType)), aTimestep            );}
    @ApiStatus.Experimental @VisibleForTesting public MultiFrameParameterCalculator       getMFPC    (double aTimestep                           ) {return MFPC.of(asList()                                                                             , aTimestep            );}
    @ApiStatus.Experimental @VisibleForTesting public MultiFrameParameterCalculator       getMFPC    (double aTimestep,            int aThreadNum) {return MFPC.of(asList()                                                                             , aTimestep, aThreadNum);}
    @ApiStatus.Experimental @VisibleForTesting public MultiFrameParameterCalculator       getTypeMFPC(double aTimestep, int aType                ) {return MFPC.of(AbstractCollections.map(asList(), atomData -> atomData.operation().filterType(aType)), aTimestep            );}
    @ApiStatus.Experimental @VisibleForTesting public MultiFrameParameterCalculator       getTypeMFPC(double aTimestep, int aType, int aThreadNum) {return MFPC.of(AbstractCollections.map(asList(), atomData -> atomData.operation().filterType(aType)), aTimestep, aThreadNum);}
}
