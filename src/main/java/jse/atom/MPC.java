...
public final class MPC extends MonatomicParameterCalculator {
    public MPC(Collection<? extends IXYZ> aAtomDataXYZ, IXYZ aBox, @Range(from=1, to=Integer.MAX_VALUE) int aThreadNum, double aCellStep) {super(aAtomDataXYZ, aBox, aThreadNum, aCellStep);}
    ...
    public MPC(IAtomData aAtomData, @Range(from=1, to=Integer.MAX_VALUE) int aThreadNum, double aCellStep) {super(aAtomData, aThreadNum, aCellStep);}
}
