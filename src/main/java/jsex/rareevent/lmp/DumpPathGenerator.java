...
public class DumpPathGenerator extends AbstractHasAutoShutdown implements IPathGenerator<IAtomData> {
    ...
    DumpPathGenerator(ILmpExecutor aLMP, Iterable<? extends IAtomData> aInitAtomDataList, IVector aMesses, IInFile aGenDumpIn, double aTimestep) {
        ...
        mWorkingDir = WORKING_DIR_OF("DUMP_GEN@"+UT.Code.randID(), true);
    }
    ...
    @Override public SubLammpstrj initPoint(long aSeed) {
    ...
    @Override public List<? extends IAtomData> pathFrom(IAtomData aStart, long aSeed) {
        ...
        try {
            ...
            Lmpdat.fromAtomData(aStart, mMesses).write(tLmpDataPath);
