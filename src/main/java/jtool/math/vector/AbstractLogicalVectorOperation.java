...
import jtool.code.iterator.IBooleanSetOnlyIterator;
...
public abstract class AbstractLogicalVectorOperation implements ILogicalVectorOperation {
    ...
    @Override public ILogicalVector operate (ILogicalVector aRHS, IBooleanOperator2 aOpt) {ILogicalVector rVector = newVector_(); DATA.ebeDo2Dest(thisVector_(), aRHS, rVector, aOpt); return rVector;}
    ...
    @Override public ILogicalVector map     (IBooleanOperator1 aOpt) {ILogicalVector rVector = newVector_(); DATA.mapDo2Dest(thisVector_(), rVector, aOpt); return rVector;}
