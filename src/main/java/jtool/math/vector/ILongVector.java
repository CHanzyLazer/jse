...
import jtool.code.iterator.IHasLongSetIterator;
import jtool.code.iterator.ILongIterator;
import jtool.code.iterator.ILongSetIterator;
...
public interface ILongVector extends ISwapper, IHasLongIterator, IHasLongSetIterator, ILongVectorGetter {
    ...
    /** Groovy stuff */
    default void fill(final Closure<? extends Number> aGroovyTask) {fill(i -> aGroovyTask.call(i).longValue());}
