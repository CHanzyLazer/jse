...
public abstract class AbstractVectorOperation implements IVectorOperation {
    /** 通用的一些运算 */
    @Override public IVector ebePlus        (IVectorGetter aLHS, IVectorGetter aRHS) {IVector rVector = newVector_(newVectorSize_(aLHS, aRHS)); DATA.ebePlus2Dest_      (aLHS, aRHS, rVector); return rVector;}
    @Override public IVector ebeMinus       (IVectorGetter aLHS, IVectorGetter aRHS) {IVector rVector = newVector_(newVectorSize_(aLHS, aRHS)); DATA.ebeMinus2Dest_     (aLHS, aRHS, rVector); return rVector;}
    ...
    @Override public IVector mapLMinus      (IVectorGetter aLHS, double aRHS) {IVector rVector = newVector_(newVectorSize_(aLHS)); DATA.mapLMinus2Dest_     (aLHS, aRHS, rVector); return rVector;}
    @Override public IVector mapMultiply    (IVectorGetter aLHS, double aRHS) {IVector rVector = newVector_(newVectorSize_(aLHS)); DATA.mapMultiply2Dest_   (aLHS, aRHS, rVector); return rVector;}
    @Override public IVector mapDiv         (IVectorGetter aLHS, double aRHS) {IVector rVector = newVector_(newVectorSize_(aLHS)); DATA.mapDiv2Dest_        (aLHS, aRHS, rVector); return rVector;}
    ...
    @Override public void ebeLMinus2this    (IVectorGetter aRHS) {DATA.ebeLMinus2this_  (thisVector_(), aRHS);}
    @Override public void ebeMultiply2this  (IVectorGetter aRHS) {DATA.ebeMultiply2this_(thisVector_(), aRHS);}
    @Override public void ebeDiv2this       (IVectorGetter aRHS) {DATA.ebeDiv2this_     (thisVector_(), aRHS);}
    ...
    @Override public void mapLMinus2this    (double aRHS) {DATA.mapLMinus2this_     (thisVector_(), aRHS);}
    @Override public void mapMultiply2this  (double aRHS) {DATA.mapMultiply2this_   (thisVector_(), aRHS);}
    @Override public void mapDiv2this       (double aRHS) {DATA.mapDiv2this_        (thisVector_(), aRHS);}
